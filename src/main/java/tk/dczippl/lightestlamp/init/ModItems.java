...
public class ModItems
{
    ...
    public static final RegistryObject<Item> DEBUG_STICK = ITEMS.register("debug_stick",() -> new DebugStickItem(new Item.Properties().tab(Main.main_tab)));
    public static final RegistryObject<Item> ALCHEMICAL_DUST = ITEMS.register("chorus_fiber",() -> new Item(new Item.Properties().stacksTo(64).tab(Main.main_tab)));
    ...
    public static final RegistryObject<Item> BASIC_FILTER = ITEMS.register("basic_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(124).tab(Main.main_tab),"tooltip.lightestlamp.basic_filter"));
    public static final RegistryObject<Item> NEON_FILTER = ITEMS.register("neon_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(118).tab(Main.main_tab),"tooltip.lightestlamp.neon_filter"));
    public static final RegistryObject<Item> ARGON_FILTER = ITEMS.register("argon_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(105).tab(Main.main_tab),"tooltip.lightestlamp.argon_filter"));
    public static final RegistryObject<Item> KRYPTON_FILTER = ITEMS.register("krypton_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(83).tab(Main.main_tab),"tooltip.lightestlamp.krypton_filter"));
    public static final RegistryObject<Item> BROMINE_FILTER = ITEMS.register("bromine_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(31).tab(Main.main_tab),"tooltip.lightestlamp.bromine_filter"));
    public static final RegistryObject<Item> XENON_FILTER = ITEMS.register("xenon_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(92).tab(Main.main_tab),"tooltip.lightestlamp.xenon_filter"));
    public static final RegistryObject<Item> RADON_FILTER = ITEMS.register("radon_centrifuge_filter",() -> new FilterItem(new Item.Properties().stacksTo(1).durability(62).tab(Main.main_tab),"tooltip.lightestlamp.radon_filter"));
