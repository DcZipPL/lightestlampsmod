...
import static tk.dczippl.lightestlamp.blocks.LightestLampBlock.Type.NORMAL;
import static tk.dczippl.lightestlamp.blocks.LightestLampBlock.Type.UNDERWATER;
...
public class ModBlocks
{
    ...
    //Other lamps
    public static final RegistryObject<Block> JUNGLE_LANTERN = BLOCKS.register("jungle_lantern", () -> new JungleLanternBlock(Block.Properties.of(Material.LEAVES).sound(SoundType.PLANT)
    ...
    public static final RegistryObject<Block> VANTA_BLACK = BLOCKS.register("vanta_black", () -> new Block(Block.Properties.of(Material.WOOL).sound(SoundType.WOOL)
            .strength(0.1f,1)));
    public static final RegistryObject<Block> MONAZITE_ORE = BLOCKS.register("monazite_ore", () -> new SolidOreBlock(Block.Properties.of(Material.STONE).sound(SoundType.STONE)
            .strength(6.4f,1),2));
